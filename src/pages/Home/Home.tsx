  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="w-full bg-slate-50 flex flex-col">
        ...
        <div className="flex px-12 gap-4 overflow-x-hidden pb-8">
          {new Array(4).fill('').map((item, index) => (
            ...
            >
              <div className="w-5 bg-drark_blue "></div>
              <div className="flex flex-col w-[240px] gap-2 text-xs pt-4 pb-2">
                <div className="w-full flex flex-col pl-5 pr-5 text-xs">
                  <div className="flex flex-col cursor-pointer">
                    <h1 className="text-base px-1 pt-1">FPLMS</h1>
                    <span className="px-1 pb-1">Team-managed software</span>
                  </div>
                  <h1 className="text-gray-400 text-sm my-2 px-1 py-1">
                    QUICK ACCESS
                  </h1>
      ...
      <div className="mx-16 mt-10 flex flex-col">
        <div className="flex gap-4 text-base font-semibold text-gray-500 relative before:content-[''] before:h-[2px] before:bg-gray-300 before:absolute before:bottom-0 before:right-0 before:left-0">
